...
export function RegexExample() {
  const [packagesToExclude, setPackagesToExclude] = useState(
    '@myorg,react,some-lib'
  );
  ...
  useEffect(() => {
    ...
    setRegexResult(
      regex.test(`node_modules/${packageToCheck}/some-path`) === false
    );
  ...
  return (
    <div style={{ width: 500 }}>
      ...
      <div style={{ marginBottom: 12 }}>
        ...
        <input
          value={packageToCheck}
          onChange={(e) => setPackageToCheck(e.target.value)}
        />
